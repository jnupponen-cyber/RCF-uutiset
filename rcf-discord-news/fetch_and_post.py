...
SOURCE_COLORS = {
    ...
    "Cycling Weekly":         int("0xde1b21", 16),
    ...
    "BikeRadar":              int("0xffffff", 16),
    "BikeRadar Gravel":       int("0xffffff", 16),
    "BikeRadar Road News":    int("0xffffff", 16),
    "BikeRadar News":         int("0xffffff", 16),
